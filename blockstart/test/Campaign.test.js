...
describe('Campaigns', () => {
  ...
  it('allows a manager to make a payment request', async () => {
    await campaign.methods.createRequest('buy food', '100', accounts[2]).send({from: accounts[0], gas: '1000000'});
  ...
  it('processes requests', async () => {
    ...
    await campaign.methods.createRequest('eh', web3.utils.toWei('5', 'ether'), accounts[1]).send({from: accounts[0], gas: '1000000'});
